;(function(){
  ...
  const dict = {
    en: {
      ...
      cta: 'Start Reading',
      surah_list: 'List of Quran Surahs in Tajik Language',
      total: 'Total: ',
    ...
    ru: {
      ...
      cta: 'Начать чтение',
      surah_list: 'Список сур Корана на таджикском языке',
      total: 'Всего: ',
    ...
    tg: {
      brand: 'Тафсири осонбаён',
      title: 'Қуръон бо забони тоҷикӣ',
      subtitle: 'Сураҳоро бинед, тарҷумаҳо хонед ва бештар кашф кунед.',
      cta: 'Оғоз кардан',
      surah_list: 'Рӯйхати сураҳои Қуръон бо забони тоҷикӣ',
      total: 'Ҳамагӣ: ',
